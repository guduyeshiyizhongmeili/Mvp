...
public class RegisterModel3 {
    public void register(String mobile,String pwd,String code){
        ...
        Request request = new Request.Builder().post(body).url(Api.REGISTER_API3).build();
    ...
    private IRegister3 iRegister;
    public void setiRegister(IRegister3 iRegister) {
        this.iRegister= iRegister;
    }
    public  interface IRegister3{
